...
3. **Production default for v2 should remain on Gemini 2.5 Pro / 2.5 Flash / 2.5 Flash-Lite** through at least Q3 2026. The 2.5 family is GA, has stable function-calling semantics, has a published rate card, and qualifies for provisioned throughput and supervised fine-tuning today. Gemini 3.x is Preview-only and the rate card for non-global endpoints does not lock in until **2026-07-01**.
