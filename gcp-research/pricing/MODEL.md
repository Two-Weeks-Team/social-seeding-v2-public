...
2. **Content-verify agent** (D23 #7, Gemini 2.5 Flash multimodal): snapshots the post page hourly during the first 7 days, OCRs the visible view count on the post's UI, and writes the snapshot to BigQuery with the screenshot hash for evidence.
