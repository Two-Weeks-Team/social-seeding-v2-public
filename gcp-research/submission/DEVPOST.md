...
**Build pillar:** `agent-development-kit-python-2.0-beta`, `agent-studio`, `agent-garden`, `agents-cli`, `gemini-3.1-pro-preview` (final demo recording), `gemini-2.5-pro` (judgment), `gemini-2.5-flash` (bulk), `gemini-2.5-flash-lite` (classifier), `model-context-protocol`, `a2a-protocol-v0.3`, `ap2-protocol-v0.2`, `google-search-grounding`, `vertex-ai-search-agent-search`, `cloud-marketplace`.
...
**Build pillar:** `agent-development-kit-python-2.0-beta`, `agent-studio`, `agents-cli`, `gemini-2.5-flash` (tool routing), `gemini-2.5-flash-lite` (classifier), `model-context-protocol`, `a2a-protocol-v0.3`, `cloud-marketplace`.
