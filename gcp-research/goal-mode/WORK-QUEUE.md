...
>
> **Status legend**: 🔴 P0 blocking · 🟡 P1 should · 🟢 P2 nice-to-have · 🚫 blocked on operator
>
> **Last updated**: 2026-05-19 — 22-agent fleet complete; integration phase begins.

---

## P0 — Blocking (must finish before any submission attempt)

### W1 — Fix BN-9 prompt-guard regex (KR/JA/ZH)
...
### W2 — Wire capability layer to Tier-1 agents
...
### W3 — Cloud Workflows YAML wires to deployed agents
...
### W4 — End-to-end smoke test in dev mode
