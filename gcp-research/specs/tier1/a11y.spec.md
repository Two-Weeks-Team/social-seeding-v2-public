...
- **D-ID coverage**: D23 (NEW Tier-1 agent #15), D5 (Gemini 3.1 Flash-Lite — cheap structured extraction), D34 (4 locales mandatory), D29 (Multimodal differentiation), D22 (PIPA / future GDPR friendly).
- **ARCHITECTURE.md §3 row 15**: `a11y (NEW) | 1 | Gemini 3.1 Flash-Lite | vision.describe, stt.transcribe, tts.synthesize, translation.translate | None | a11y_compliance_score`.
...
sequenceDiagram
  ...
  participant AY as a11y agent (Gemini 3.1 Flash-Lite)
