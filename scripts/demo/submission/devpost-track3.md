...
- **The fleet we built (the Build stage)**: a 22-agent ADK fleet (16 domain + 3 meta-coordinators +
  3 watchdogs, per D23) on Agent Runtime, fronted by **Mission Control** (Next.js 16). A
...
|---|---|
| Marketing agent on Cloud Run / GKE | 22-agent fleet on Agent Runtime; refactored agent on Cloud Run (D17) |
