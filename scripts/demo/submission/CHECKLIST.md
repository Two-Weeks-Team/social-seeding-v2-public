...
| G-1 | pytest green | `pnpm exec pytest packages/agents-adk` | `0 failed`, **2933 passed** | brief 2026-05-20 |
...
| Accomplishments | "Accomplishments we're proud of" | 150–250 | **40.5%→100% train / 71.4% holdout (28.6pp gap)** + A2A-in-workflow ~3.7s + 6 requirements + 2933 tests + real Imagen |
...
> 2933, train 100% / holdout 71.4%) and the grand-narrative ordering before upload. The hero MUST be
