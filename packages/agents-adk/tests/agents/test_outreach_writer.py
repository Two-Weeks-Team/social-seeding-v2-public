...
class TestPlumbing:
    ...
    def test_agent_def_shape_matches_spec(self) -> None:
        ...
        assert outreach_writer_agent_def.model == "gemini-2.5-pro"
        ...
        assert outreach_drafter_agent_def.model == "gemini-2.5-pro"
        assert outreach_drafter_agent_def.max_usd <= 0.05
        assert outreach_judge_agent_def.model == "gemini-2.5-pro"
...
class TestAgentDefShape:
    ...
    def test_all_three_defs_use_pro_model_per_d5(self) -> None:
        """D5 — Gemini 2.5 Pro for judgment + drafting. The tournament's bulk
