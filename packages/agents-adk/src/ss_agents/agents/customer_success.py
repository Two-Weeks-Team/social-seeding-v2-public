...
Citations:
    D5   — Gemini 2.5 Pro (judgment over multi-source signals).
...
# Gemini 2.5 Pro per task brief + ARCHITECTURE.md §3 row 16. The
...
DEFAULT_CUSTOMER_SUCCESS_MODEL = "gemini-2.5-pro"
...
customer_success_agent_def: AgentDef[
    ...
    description=(
        ...
        "metrics UPSTREAM of this agent. Gemini 2.5 Pro for multi-signal "
