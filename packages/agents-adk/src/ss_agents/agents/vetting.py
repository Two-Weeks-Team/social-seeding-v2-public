...
Citations:
    D5  — Gemini 3.1 Pro for judgment-grade scoring.
    ...
    ARCHITECTURE.md §3 row 2:
        vetting | 1 | Gemini 3.1 Pro (parallel) | rapidapi.get_user_info,
    ...
    upgraded Haiku → Gemini 3.1 Pro per D5.
"""
...
vetting_agent_def: AgentDef[VettingInput, VettedCandidate] = AgentDef(
    ...
    model="gemini-3.1-pro",  # D53 — judgment role.
