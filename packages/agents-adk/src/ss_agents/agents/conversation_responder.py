...
onto ADK + Gemini 3.1 Pro + Pydantic, following the contract in
...
Citations:
    D5  — Gemini 3.1 Pro (judgment-heavy creative drafting).
    ...
    ARCHITECTURE.md §3 row 5:
        conversation_responder | 1 | Gemini 3.1 Pro | templates.list,
...
# D53: Gemini 3.1 Pro for judgment-heavy drafting. Per
# `gcp-research/decisions/DECISIONS.md` line 44 + ARCHITECTURE.md §3 row 5.
RESPONDER_MODEL = "gemini-3.1-pro"
